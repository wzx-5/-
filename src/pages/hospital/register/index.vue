        ...
        <div class="content">
            ...
            <div class="right">
                ...
                <div class="releaseTime">
                    退号时间:就诊前一工作日前{{ hospitalStore.hospitalInfo.bookingRule?.quitTime }}取消
                </div>
                <div class="rule">
                    预约挂号规则
                </div>

                <div class="ruleInfo" v-for="(item, index) in hospitalStore.hospitalInfo.bookingRule?.rule"
                    :key="index">
                    {{ item }}
                </div>
            ...
            <div class="leftNav">
                <ul>
                    <li :class="{ active: currentIndex == index }"
                        v-for="(department, index) in hospitalStore.departmentArr" :key="department.depcode"
                        @click="changeIndex(index)">
                        {{ department.depname }}</li>
                </ul>
            </div>
