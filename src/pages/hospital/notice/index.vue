<template>
    <div class="notice">
        <h1 class="hosname">
            {{ hospitalDetailStore.hospitalInfo.hospital?.hosname }}预约挂号通知
        </h1>
        <div class="top">为方便您早点就医康复，请您认真阅读预约挂号须知:</div>
        <div class="info">
        ...
        <div class="info">
            ...
            <div class="text">
                已完成预约的号源，如需办理退号，至少在就诊前一工作日14:00 前通过网站、微信公众号、114电话等平台预约渠道进行取消预约。
            </div>
        </div>
        <div class="info">
